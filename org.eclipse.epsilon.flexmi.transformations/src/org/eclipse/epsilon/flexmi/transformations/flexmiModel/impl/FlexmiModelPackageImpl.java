 ...
 * @generated
 */
public class FlexmiModelPackageImpl extends EPackageImpl implements FlexmiModelPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass flexmiModelEClass = null;
	 ...
	 * @see org.eclipse.epsilon.flexmi.transformations.flexmiModel.FlexmiModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private FlexmiModelPackageImpl() {
		super(eNS_URI, FlexmiModelFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link FlexmiModelPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static FlexmiModelPackage init() {
		if (isInited) return (FlexmiModelPackage)EPackage.Registry.INSTANCE.getEPackage(FlexmiModelPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredFlexmiModelPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		FlexmiModelPackageImpl theFlexmiModelPackage = registeredFlexmiModelPackage instanceof FlexmiModelPackageImpl ? (FlexmiModelPackageImpl)registeredFlexmiModelPackage : new FlexmiModelPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theFlexmiModelPackage.createPackageContents();

		// Initialize created meta-data
		theFlexmiModelPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theFlexmiModelPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(FlexmiModelPackage.eNS_URI, theFlexmiModelPackage);
		return theFlexmiModelPackage;
	}
	 ...
	 */
	@Override
	public EClass getFlexmiModel() {
		return flexmiModelEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getFlexmiModel_Nsuri() {
		return (EAttribute)flexmiModelEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getFlexmiModel_Includes() {
		return (EAttribute)flexmiModelEClass.getEStructuralFeatures().get(2);
	}
	...
	public EReference getFlexmiModel_Tags() {
		return (EReference)flexmiModelEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public FlexmiModelFactory getFlexmiModelFactory() {
		return (FlexmiModelFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(flexmiModelEClass, FLEXMI_MODEL__INCLUDES);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getFlexmiModel_Includes(), ecorePackage.getEString(), "includes", null, 0, -1, FlexmiModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
